...
try:
	...
	raise ImportError( 'Need to install PyQt5, run: pip install PyQtChart' )
...
class Device_Communicator( QtCore.QObject ):
	...
	def __init__( self, parent, identifier_string, listener_address=None, port=999, ip_range=None, timeout_ms=20000 ):
	...
	def Attempt_Serial_Connection( self ):
		...
		return False
	need to finish adding serial stuff to work same as ip stuff
